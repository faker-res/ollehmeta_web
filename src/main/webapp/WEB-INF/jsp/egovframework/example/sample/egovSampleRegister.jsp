...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_selectList() {
           	document.detailForm.action = "<c:url value='/example/egovSampleList.do'/>";
           	document.detailForm.submit();
        }
        
        /* 글 삭제 function */
        function fn_egov_delete() {
           	document.detailForm.action = "<c:url value='/example/deleteSample.do'/>";
           	document.detailForm.submit();
        }
        ...
        function fn_egov_save() {
        	...
        	if(!validateSampleVO(frm)){
            	...
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/egovframework.example/addSample.do' : '/egovframework.example/updateSample.do'}"/>";
                frm.submit();
            }
        }
