...
@Component
public class OllehHttpClientUtil {
            ...
            try {
                ...
                if (entity != null) {
                    ...
                    try {
                        ...
                        resultStr = IOUtils.toString(istream, String.valueOf(detCharset));
...
//                } else {
//                    byte[] value0 = ((String)paramsMap.get(key)).getBytes("utf-8");
//                    String value = new String (value0, "utf-8");
//                    request.addParameter(key, URLEncoder.encode(value, "UTF-8"));
//                }
